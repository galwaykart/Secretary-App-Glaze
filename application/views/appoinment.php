                  ...
                  <div class="col-md-12 heading-tag">
                    <p>
                      <span class="fa fa-home" ></span>&nbsp;Home / Appointment
                    </p>
                  </div>
                  <div class="container">
    ...
                 
                  ...
                  <div class="popup-main">
                    ...
                    <form id="my2Form" method="POST" action=""
                      <?php echo base_url();?>Appoinment/req" >
                    ...
                    <div class="left">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <div class="form-control">
                            <input required="" type="text" name="delegate_phone[]" value="'+data_json.insidequickwork[j].phone_number+'"/>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <script type="text/javascript">
                    ...
                    $('#auto-del').append('<div class="clear"></div><div id="rm'+lnth+'" class="auto-del">
                      <div class="auto-del">
                        <div class="left">
                          <div class="form-group">
                  ...
                  <script type="text/javascript">
                    ...
                    for(var i=0; i<data_json.insidequickwork.length ; i=''
                                          var='' j = 'i' +1=''
                        .append=''('<div class="clear"></div><div id="rm'+i+'" class="auto-del">
                      <div class="auto-del">
                        <div class="left">
                          <div class="form-group">
                            <label>Appointment With</label>
                            <div class="input-group">
                              <div class="form-control">
                                <input required="" type="text" title="Delegate To" name="delegate_to[]" value="'+ data_json.insidequickwork[j].appointment_with_name +'" />
                              </div>
                            </div>
                          </div>
                        </div>
                        <div class="center">
                          <div class="form-group">
                            ...
                            <div class="input-group">
                              <div class="form-control">
                                <input required="" type="text" name="delegate_email[]" value="'+data_json.insidequickwork[j].appointment_with_email+'"/>
                              </div>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="right text-center">
                          <div class="btn-group">
                            <a style="background: red;" href="#"  onclick="setValues('+ i + ')">
                              <span class="fa fa-minus" style="color: white;"></span>
                            </a>
                          </div>
                        </div>
