							...
							<div class="form-group">
								...
								<div class="input-group">
									<div class="form-control">
										<input type="date" title="Prev Meeting Date" name="previous_date" value="<?php if($fetch){ echo $fetch[0]->date_of_meeting;} ?>" >
									</div>
								</div>
							</div>
						</div>
							...
							<div class="col-md-12 meet-second-panel">
								<div class="container4">
											<div class="col-md-4">
											 ...
											 <div class="col-md-8">
												 <input type="text" placeholder="Ajenda of metting" name="agenda" value="<?php if($fetch){ echo $fetch[0]->agenda_id;} ?>" />
											</div>
									</div>
						   </div>
                                                     ...
                                                     <div class="col-md-2" class="RegSpLeft" id="addmr" >
                                                             <div class="form-group" >
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="form-control"><input type="text" placeholder="Department" id="department" name="department[]" value="<?php if($fetch){ echo $fetch[0]->department;} ?>" /></div>
                                                                </div>
                                                        </div>
                                                     </div> 
                                                     <div class="col-md-2" class="RegSpLeft" id="addmr">
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="form-control"><input type="text" placeholder="Employee" id="employee" name="employee[]" value="<?php if($fetch){ echo $fetch[0]->employee;} ?>"  /></div>
                                                                </div>
                                                        </div>
                                                     </div>  
                                                     <div class="col-md-2" class="RegSpLeft" id="name">
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="form-control"><input type="text" placeholder="Name" id="name" name="name[]" value="<?php if($fetch){ echo $fetch[0]->name;} ?>" /></div>
                                                                </div>
                                                        </div>
                                                     </div>  
                                                     <div class="col-md-2" class="RegSpLeft" id="email">
                                                            <div class="form-group">
                                                                <div class="input-group">
                                                                    ...
                                                                    <div class="form-control"><input type="text" placeholder="Email Id" id ="email" name="email[]" value="<?php if($fetch){ echo $fetch[0]->email;} ?>"/></div>
                                                                </div>
                                                        </div>
                                                     </div>  
                                                     <div class="col-md-2">
