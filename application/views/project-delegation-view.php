    ...
    <div class="col-md-12">
      ...
      <div class="project-panel-top">
        ...
        <form method="POST" action=""
          ...
          <div class="footer">
            <div class="col-md-12 btn-group margin-top text-center">
              <button type="submit" class="btn-primary btn">Save</button>
              <?php if($this->uri->segment(3)){?>
              <button  name="submail" class="btn-primary btn" >
        ...
        <div class="clear"></div>
        <h2 class="prodelegationviewbottomheadiline margin-top">Extended Sheet</h2>
        ...
        <div class="clear"></div>
        <h2 class="prodelegationviewbottomheadiline">Project Status </h2>
        <div class="delegatesheet-view">
